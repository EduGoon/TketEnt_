...
async function downloadTicketAsPng(ticket: Ticket) {
 ...
 ctx.fillStyle = "rgba(255,255,255,0.2)"; ctx.font = "9px monospace";
  ...
  ctx.fillText("Eventify", W / 2, H - 12);
 if (ticket.qrCode) {
...
export default function UserAccountPage() {
  ...
  <div style={{ marginTop: 24, padding: '20px 24px', background: 'linear-gradient(160deg,rgba(240,192,64,0.07),rgba(240,192,64,0.03))', border: '1px solid rgba(240,192,64,0.15)', borderRadius: 14 }}>
    ...
    <p style={{ fontSize: 12, color: 'rgba(255,255,255,0.4)', lineHeight: 1.7, marginBottom: 14 }}>Apply to become an organizer and start selling tickets for your events on Eventify.</p>
